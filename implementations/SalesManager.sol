...
contract SalesManager is ISalesManager, PausableUpgradeable, UUPSUpgradeable {
  ...
  /// @notice slither warning: unused-return -- not needed for approve
  /// @notice slither warning: low-level-calls -- needed to perform swap
  ...
  /// @notice slither warning: unchecked-transfer -- checked through _callDEXSwap function
